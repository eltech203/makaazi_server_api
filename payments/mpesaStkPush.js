...
router.post("/mpesa_stk_push", access, _urlencoded,  function(req, res) {
    ...
    request({
            ...
            json: {
                ...
                CallBackURL:'https://makaaziserverapi-production-c036.up.railway.app/payment/stk_callback',
     ...
     request(
         {
             ...
             json:{
                ...
                "IdentifierType":"4",
                "QueueTimeOutURL":"https://makaaziserverapi-production-c036.up.railway.app/payment/timeout_status",
                "ResultURL":"https://makaaziserverapi-production-c036.up.railway.app/payment/result_status",
                "Remarks":"OK",
                "Occasion":"OK",
             }
         },
  ...
  let  phone_number = req.body.phone_number;
    ...
    request({
            ...
            json: {
                ...
                CallBackURL:'https://makaaziserverapi-production-c036.up.railway.app/payment/subscription_callback',
