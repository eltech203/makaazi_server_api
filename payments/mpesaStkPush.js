     ...
     request(
         {
             ...
             json:{
                ...
                "IdentifierType":"4",
                "QueueTimeOutURL":"https://makaaziserverapi-production-252f.up.railway.app/payment/timeout_status",
                "ResultURL":"https://makaaziserverapi-production-252f.up.railway.app/payment/result_status",
                "Remarks":"OK",
                "Occasion":"OK",
             }
         },
  ...
  let  phone_number = req.body.phone_number;
    ...
    request({
            ...
            json: {
                ...
                CallBackURL:'https://makaaziserverapi-production-252f.up.railway.app/payment/subscription_callback',
                AccountReference: "INTEC Payment sandbox",
                TransactionDesc: "Make payment to SCM router of INTEC",
            }, 
        },
